...
//                         <div className='w-80 flex justify-start items-center space-x-6 pl-4 text-left'>
//                             <div className='text-lg capitalize '>comment</div>
//                             <Link href={'/signup'} className='w-full  text-center py-2 capitalize bg-blue-900/30 bg-gradient rounded-lg ring-1 flex justify-center items-center'>add new comment</Link>
//                         </div>
//                     </div>
