    ...
    <section className="flex flex-col justify-center items-center h-fit w-full bg-darkmodebtncolor text-white py-16">
      <div className="w-11/12  flex flex-col md:flex-row justify-evenly items-center">
        ...
        <div className="text-sm text-gray-500 w-[50%] text-center">
          Ready to grow your business online? Our professional services are
          designed to help you stand out and succeed in the digital world. From
          strategy to execution, we offer the tools and expertise your business
