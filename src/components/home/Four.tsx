...
const Four = () => {
  return ( 
    <section  className='flex flex-col justify-center items-center w-full '>
        ...
        <div className='grid grid-cols-3 grid-rows-4 w-full h-full gap-6 '>
            <div className='card-style row-span-2 col-span-2 rounded-2xl p-3 relative'> 
                <div className='ring-1 ring-gray-300 rounded-2xl w-fit px-4 text-sm bg-white'>Lorem, ipsum.</div>
                <div className='font-bold py-3'>COMPLETED PROJECTS</div>
