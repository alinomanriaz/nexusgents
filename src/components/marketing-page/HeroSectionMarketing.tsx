        ...
        <section className=' hero-section  flex flex-col items-center justify-center h-[calc(100dvh-50px)]'>
            <div className=' flex justify-center items-center text-center flex-col overflow-hidden w-full sm:px-10'>
                ...
                <div className='space-x-4 py-6'>
                    <Button className={'bg-darkmodebtncolor w-full sm:w-auto dark:bg-gradient text-white rounded-lg sm:rounded-full'} btname={'Get started'} />
                    <Button className={'bg-white dark:bg-transparent ring-1 ring-gray-500/20 w-full sm:w-auto rounded-lg sm:rounded-full'} btname={'Learn more'} />
                </div>
            </div>
